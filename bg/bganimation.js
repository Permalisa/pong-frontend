...
function getRandomInt(min, max) {
  ...
  // Function to generate a random rotation speed
  function getRandomRotationSpeed() {
    return Math.random() * 2 + 0.5; // Random speed between 0.5 and 2 degrees per frame
  }
  ...
  // Start the face movement when the window loads
  window.onload = moveFaces;
